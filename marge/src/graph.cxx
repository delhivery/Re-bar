...
void BaseGraph::check_kwargs(const std::map<std::string, ::any>& kwargs, ::string_view key) {
...
void BaseGraph::check_kwargs(const std::map<std::string, ::any>& kwargs, const std::list<::string_view>& keys) {
