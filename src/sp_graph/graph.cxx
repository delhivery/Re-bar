...
namespace expath {
    ...
    std::vector<std::string> expath::Expath::EPGraph::time_dependent_shortest_path(
    ...
    template <typename Compare> void expath::Expath::EPGraph::time_dependent_shortest_path(
            expath::Vertex source, expath::Vertex destination, expath::DistanceMap& distances, expath::PredecessorMap& predecessors, Compare& cmp, expath::Cost inf, expath::Cost zero, double t_max) {
    ...
    std::pair<DistanceMap, PredecessorMap> Expath::tdsp_wrapper(std::string src, std::string dst, double t_start, double t_max) {
        DistanceMap distances(boost::num_vertices(g));
        PredecessorMap predecessors(boost::num_vertices(g));
    ...
    std::vector<std::pair<Cost, std::pair<std::string, std::string> > > Expath::get_path(
